...
showalldata=0
enable=[0,0,0,1]
SN=['55000769','55000617','55000392','55000769']
tolerance=0.05
target=[0.50,0.0685,0.266,0.900]
KP=[1,60,0,1]
KI=[1,1,0,0.1]
triglist=[0,1,0,0]
delaytime=[0.01,0,0,0.01]
readonly=0
tintegral=[0.004,0.003,0.01,0.004]
    ...
    for j in range(4):
	   ...
	   # time.sleep(1)
        ...
        for k in range(trig[j].lent):
            ...
            if data0ave/target[x[i].xid] > (1+tolerance) or data0ave/target[x[i].xid] < (1-tolerance):
                GPIO.output(36,1)
            else:
                GPIO.output(36,0)
